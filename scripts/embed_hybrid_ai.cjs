...
function embedHybridAI(outputFilePath) {
    ...
    // 2. Define the new nodes to be added (excluding FAQ responder)
    const newNodes = [
        ...
        // Webhook responders for greeting
        {
            "parameters": {
                "respondWith": "json",
        ...
        // Node 1: Greeting Generator (Time-aware)
        makeOpenAINode(
    ...
    // 3. Clean up Respond node values to receive AI output
