                ...
                <>
                    ...
                    <div className="doc-page">
                        ...
                        <section style={{ fontSize: '0.85rem', color: '#334155', textAlign: 'justify', lineHeight: '1.6' }}>
                            ...
                            <p style={{ marginBottom: '2rem' }}>En base a lo indicado en párrafos anteriores, el padre, madre o tutor/a legal del menor autoriza expresamente a Centro Infantil Proyecta, S.L. al tratamiento de datos de sus hijos o tutelados teniendo en cuenta que algunos de los datos tratados están categorizados como de especial protección.</p>
                        </section>
                        <SignatureBox
                    ...
                    <div className="doc-page">
                        ...
                        <section style={{ fontSize: '0.85rem', color: '#334155', textAlign: 'justify', lineHeight: '1.6' }}>
                            <p style={{ marginBottom: '1rem' }}>En cumplimiento de lo establecido en el Reglamento General de Protección de Datos (RGPD) (UE) 2016/679 y en la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos de Carácter Personal y Garantía de los Derechos Digitales (LOPD y GDD), le informamos que sus datos serán incorporados en nuestro sistema de tratamiento con la finalidad de prestarle el servicio solicitado, realizar la gestión administrativa derivada de nuestra relación contractual, así como enviarle a través de WhatsApp, avisos y recordatorios relacionados con las citas concertadas. Si prefiere no recibir estos avisos por WhatsApp, podrá comunicarlo al centro en cualquier momento y se utilizará otro medio de contacto. Solo serán solicitados aquellos datos que sean pertinentes, necesarios, adecuados y no excesivos, pudiendo ser necesario recoger datos de contacto de terceros, tales como representantes legales, tutores, o personas a cargo designadas por los mismos.</p>
